...
class AddCredential extends Component {
    ...
    //updates the make username in the postBody state upon change of its corresponding input field 
        ...
        return (
            <div className = "centerContainer">
                ...
                <div className="txt_field">
                    ...
                    <div className="txt_field">
                        <input type="text" required value = {this.state.postBody.service} onChange={this.handleServiceChange}/>
                        <span></span>
                        <label>Password</label>
                    </div>
